...
Tags matching the package version, such as `v0.1.8`, trigger the release workflow. The workflow runs the quality gate, builds Windows portable executables, macOS DMG/ZIP packages, and Linux AppImage/DEB/tar.gz packages, then publishes the platform artifacts as GitHub Release assets.
