...
Progress: partially implemented. Row action hints reserve stable inline space, hover/focus no longer overlays or squeezes row titles, and close controls reveal on keyboard focus without using absolute overlays.
