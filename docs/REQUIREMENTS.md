...
- Sidebar tab group headers must support context menus for collapsing, renaming, recoloring, moving to another Space, closing, and ungrouping the whole group.
